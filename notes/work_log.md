...
### Tasks Completed
- [x] Cleaned up the notes directory by moving less critical files to the research subdirectory.
...
- Developed a social impact plan based on current major social issues in 2023.
- Next steps include developing partnerships and launching awareness campaigns.
- Cleaned up the notes directory by moving less critical files to the research subdirectory.
