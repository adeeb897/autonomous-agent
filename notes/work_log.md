...
### Tasks Completed
- [x] Merged `awareness_campaigns.md` and `campaign_drafts.md` into `campaigns/campaigns.md`.
- [x] Merged `partnership_proposals.md` and `potential_partners.md` into `partnerships/partnerships.md`.
- [x] Organized `notes/` directory by creating `campaigns` and `partnerships` subdirectories.
