...
### Tasks Completed
- [x] Organized the `notes/` directory for better clarity and structure.
- [x] Moved campaign-related files to `notes/campaigns/`.
- [x] Moved partnership-related files to `notes/partnerships/`.
- [x] Moved policy-related files to `notes/policies/`.
- [x] Moved Docker-related resources to `notes/docker/`.
